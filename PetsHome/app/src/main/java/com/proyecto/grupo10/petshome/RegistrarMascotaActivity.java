            ...
            public void onClick(View view) {
                ...
                new Thread(() -> {
                    try {
                        ...
                        URL url;
                        if(editar) {
                            url = new URL("http://192.168.1.35:8081/mascota/" + idMascota);
                            metodo = "PUT";
                            Log.i("debug", "editando la mascota");
                            Log.i("debug", url.toString());
                        } else {
                            url = new URL("http://192.168.1.35:8081/mascota");
                            metodo = "POST";
                        }
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    String urlStr = "http://192.168.1.35:8081/mascota/delete/" + idMascota ;
